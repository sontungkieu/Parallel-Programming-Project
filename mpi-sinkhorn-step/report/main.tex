...
Kiều Sơn Tùng & 20235571 & MPI implementation, row-wise decomposition, benchmark run scripts, and optimization experiments including communication variants and dynamic scheduling \\
\bottomrule
\end{tabularx}
