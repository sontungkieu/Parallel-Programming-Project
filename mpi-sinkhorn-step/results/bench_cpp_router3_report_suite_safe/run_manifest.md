# Router3 Report Suite Manifest

| experiment | config | purpose |
|---|---|---|
| baseline | np=3, sizes=2000 3000 4000 5000 6000 7000 8000 9000 10000 11000 12000, reps=4, iters=50 | Runtime vs input size on router |
...
| load_balance | np=6, size=8000, reps=3, iters=50 | Per-rank granularity/load-balance snapshot |
